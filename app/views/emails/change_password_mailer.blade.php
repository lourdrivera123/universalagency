...
<tr>
    <td>
        ...
        <span style="font-size:18px;font:Helvetica Neue;color:#ffffff;display:inline-block;line-height:25pt;margin-right:1em"><img src="{{ URL::asset('images/logo_wew.png') }}" width="160" height="50" alt="Universal Agency"></span></span>
        </div>
...
<td style="font-size:10.5pt;width:100%"><b>Hey {{UCfirst($firstname)}},</b> 
<tr>
<td><br><br>Just to remind you, you just changed your password. <br> If this is surprising to you, don't worry, you can still reset your password <a href="{{ URL::to('password/remind') }}"> here.</a> </td>
