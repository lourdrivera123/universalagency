...
<head>
    <meta charset="UTF-8">
    <title>Invitation for Job</title>
</head>
...
<tr>
    <td>
        ...
        <img src="{{ URL::asset('images/logo_wew.png') }}" width="160" height="50" alt="Universal Agency">
        </span>
        </div>
