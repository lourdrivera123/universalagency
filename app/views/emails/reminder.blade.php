...
<tr>
    <td>
        ...
        <span style="font-size:18px;font:Helvetica Neue;color:#ffffff;display:inline-block;line-height:25pt;margin-right:1em"><img src="images/logo_wew.png" width="160" height="50" alt="Universal Agency"></span>
        </div>
...
<td style="font-size:10.5pt;width:100%"><h3>Password Reset</h3> 
<tr>
<td><br>To reset your password, complete this form: {{ URL::to('password/reset', array($token)) }}.<br/>
