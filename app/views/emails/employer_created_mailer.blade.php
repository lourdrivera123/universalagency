...
<head>
    <meta charset="UTF-8">
    <title>Employer Account Created</title>
</head>
...
<tr>
    <td>
        ...
        <span style="font-size:18px;font:Helvetica Neue;color:#ffffff;display:inline-block;line-height:25pt;margin-right:1em"><img src="{{ URL::asset('images/logo_wew.png') }}" width="160" height="70" alt="Universal Agency"></span>
        </div>
...
<td style="font-size:10.5pt;width:100%"><b>Hi {{UCfirst($businessname)}},</b> 
<tr>
<td><br><br>We would like to inform you that your account has been created. <br> 
    Please use this password: {{ $password }}</td>
