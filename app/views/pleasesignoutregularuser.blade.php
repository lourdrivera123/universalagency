...
<div class="content-wrapper hide-until-loading"><div class="body-wrapper">
    <div class="container">
        <div class="row">
            ...
            <center>
            <h1 class="error-text-2">Please Sign Out<span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span> </h1>
            </center>
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 centered">
            <div class="classic-form">
                <h3>You need to Sign Out First Before Accessing Admin Panel</h3>
