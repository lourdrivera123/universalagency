...
@section('title')
<title>Page Not Found | Universal Agency</title>
@stop

@section('description')
<meta name="description" content="Universal Agency Page Not Found">
@stop
...
<div class="content-wrapper hide-until-loading"><div class="body-wrapper">
    <div class="container">
        <div class="row">
            ...
            <center>
            <h1 class="error-text-2">Page Not Found <span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span> </h1>
            </center>
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 centered">
            <div class="classic-form">
                <h1> We don't want to dissappoint you, but the page you are looking for is not available </h1>							              
            </div>
        </div>
