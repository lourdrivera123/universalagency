...
@section('title')
	<title>Employer DTR Upload | Universal Agency</title>
@stop
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="page-info">
                        <h1 class="h1-page-title">DTR UPLOAD</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 animated" data-animtype="flipInY"
                         ...
                         data-speed="1s"
                         data-delay="0.5s">
                        <h2 class="h2-section-title">DTR Upload form</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 centered">
                        <div class="classic-form">
                            {{ Form::open(['id' => 'uploaddtrform', 'files' => 'true', 'action' => 'DtrController@store']) }} 
